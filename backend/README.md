...
## Project Structure
    ...
    ├── testapiautoteammemb_90150  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_90150`
...
2. Clone this repo and `cd testapiautoteammemb_90150`
